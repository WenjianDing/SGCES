...
"""
    ...
    try:
        ...
        predict_result, history = model.chat(tokenizer, None, text_prompt, generation_config, history=None, return_history=True)
        # print('prompt')
        # print(prompt)

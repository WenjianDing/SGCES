...
#  配置区
# ══════════════════════════════════════════════════════════
DATA_PATH        = "C:/Work/pricai/ct_data.json"
OUTPUT_PATH      = "C:/Work/pricai/medcpt_top3.json"
TOP_K            = 3
BATCH_SIZE       = 128
MAX_LENGTH       = 512
DEVICE           = "cuda" if torch.cuda.is_available() else "cpu"

QUERY_MODEL_NAME = ".../MedCPT-Query-Encoder"
DOC_MODEL_NAME   = ".../MedCPT-Article-Encoder"
# ══════════════════════════════════════════════════════════

...
example_data_path = "C:/Work/pricai/ct_few_shot_examples.json"
save_data_path = "C:/Work/pricai/result/baseline/gpt5mini_baseline.json"
...
for i in tqdm(range(test_data_length)):
    ...
    Frontal_img_name = 'C:/Work/pricai/dataset/ct_images/images_normalized/' + str(each_Frontal_name)
    ...
    **Current Case**
    ...
    try:
        # 转换本地图片为 base64
        base64_image = encode_image(Frontal_img_name)

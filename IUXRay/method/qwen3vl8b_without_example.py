...
save_data_path = "/root/autodl-tmp/ct_project/qwen3vl8b_baseline_without_example.json"
...
for i in tqdm(range(test_data_length)):
    ...
    Frontal_img_name = '/root/autodl-tmp/ct_project/ct_images/images_normalized/' + str(each_Frontal_name)
